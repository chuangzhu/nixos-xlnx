...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = let
    fetchYoctoPatch = file: hash: fetchurl {
      url = "https://git.yoctoproject.org/meta-xilinx/plain/meta-xilinx-core/recipes-graphics/mali/kernel-module-mali/${file}.patch?h=fd359f0cf8973aff3fa46cd43111e093fbad26a1";
      inherit hash;
    };
  in[
    ...
    (fetchYoctoPatch "0025-Import-DMA_BUF-module-and-update-register_shrinker-f" "sha256-s+QNkD/bNIZm1gAW8/dsuiTNMr3p81x7kQRM7V/7Woo=")
