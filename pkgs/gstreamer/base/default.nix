...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://github.com/Xilinx/gst-plugins-base/archive/refs/tags/xlnx-rebase-v1.18.5_2022.2.tar.gz";
    sha256 = "sha256-enGq38FlOmsP2StczPrXJwKorsLdHtCn+IGp3jZZ9PM=";
  };
